<template>
    <div class="designer-config-panel" v-if="open">
        <div class="panel-container">
            ...
            <div class="section-header">
                <span class="section-title">多语言设置 <a href="https://pro.form-create.com/doc/form-locale"
                                                          target="_blank"><i
            ...
            <div class="section-header">
                <span class="section-title">功能设置 <a href="https://pro.form-create.com/doc/hidden-item"
                            ...
                            <div class="setting-item">
                                    <span class="item-title">{{ child.label }}
                                        <template v-if="child.img">
                                            ...
                                            <a href="https://pro.form-create.com/doc/hidden-module" target="_blank"><img
            ...
            <!-- 菜单设置 -->
            <div class="section-header">
                <span class="section-title">菜单设置 <a href="https://pro.form-create.com/doc/hidden-item"
                                                        target="_blank"><i class="fc-icon icon-question"></i></a></span>
            </div>
            <div>
            ...
            <div class="section-header">
                <span class="section-title">操作权限 <a href="https://pro.form-create.com/doc/component-permission"
                                                        target="_blank"><i class="fc-icon icon-question"></i></a></span>
            </div>
            <div class="permission-block">
                <template v-for="(com, idx) in componentPermission">
                    <div class="permission-item">
                        <el-select multiple clearable size="default" placeholder="请选择" v-model="com.tag"
                                   style="width: 100%">
    ...
    <div v-else class="designer-config-float" @click="open=true">
...
export default {
    ...
    data() {
        return {
            ...
            ${this.activeLocale === 'zh-cn'? '' : this.activeLocale }
        }
    }
}
<\/script>`
        ...
        open(n) {
            if (n && !this.init) {
                ...
                this.menus.forEach((menu) => {
                    ...
                    if (menu.list) {
                        this.$set(menu, 'checked', menu.list.map(item => item.name));
                    }
                });
                this.addPermission();
                this.activeFeature = {
