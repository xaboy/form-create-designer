<template>
    <div class="_fd-shadow-content">
        <a-form size="small" layout="vertical" class="_fd-sc-form">
            <a-form-item :label="t('style.shadow.mode')">
                <a-radio-group v-model:value="form.type" @change="onInput" size="small" class="_fd-sc-radio">
                    <template v-for="item in options" :key="item.key">
                        <a-tooltip
                            :title="t('style.shadow.' + item.key)"
                            placement="top"
                        >
            ...
            <a-form-item :label="t('style.shadow.x')">
                <a-input v-model:value="form.x" type="number" @change="onInput">
                    <template #addonAfter>
                        <a-select v-model:value="form.x_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :value="item">
                                {{ item }}
                            </a-select-option>
                        </a-select>
                    </template>
            ...
            <a-form-item :label="t('style.shadow.y')">
                <a-input v-model:value="form.y" type="number" @change="onInput">
                    <template #addonAfter>
                        <a-select v-model:value="form.y_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :value="item">
                                {{ item }}
                            </a-select-option>
                        </a-select>
            ...
            <a-form-item :label="t('style.shadow.vague')">
                <a-input v-model:value="form.vague" type="number" @change="onInput">
                    <template #addonAfter>
                        <a-select v-model:value="form.vague_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :value="item">
                                {{ item }}
                            </a-select-option>
                        </a-select>
            ...
            <a-form-item :label="t('style.shadow.extend')">
                <a-input v-model:value="form.extend" type="number" @change="onInput">
                    <template #addonAfter>
                        <a-select v-model:value="form.extend_unit" @change="onInput">
                            <a-select-option v-for="item in units" :key="item" :value="item">
                                {{ item }}
                            </a-select-option>
                        </a-select>
