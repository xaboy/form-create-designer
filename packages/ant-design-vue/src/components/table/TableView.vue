                                        ...
                                        <div class="_fd-drag-btn _fd-table-view-btn">
                                            <a-dropdown trigger="click" size="default">
                                                ...
                                                <template #overlay>
                                                    <a-menu>
                                                        <a-menu-item
                                                            @click="command(['addCol', [{pid,idx,data: lattice[pid][idx]}, 1]])">
                                                            {{ t('tableOptions.addLeft') }}
                                                        </a-menu-item>
                                                        <a-menu-item
                                                            @click="command(['addCol', [{pid,idx,data: lattice[pid][idx]}, 0]])">
                                                            {{ t('tableOptions.addRight') }}
                                                        </a-menu-item>
                                                        <a-menu-item
                                                            @click="command(['addRow', [{pid,idx,data: lattice[pid][idx]}, 1]])">
                                                            {{ t('tableOptions.addTop') }}
                                                        </a-menu-item>
                                                        <a-menu-item
                                                            @click="command(['addRow', [{pid,idx,data: lattice[pid][idx]}, 0]])">
                                                            {{ t('tableOptions.addBottom') }}
                                                        </a-menu-item>
                                                        <a-menu-divider/>
                                                        <a-menu-item :disabled="lattice[pid][idx].right"
                                                                     @click="command(['mergeRight', [{pid,idx,data: lattice[pid][idx]}]])">
                                                            {{ t('tableOptions.mergeRight') }}
                                                        </a-menu-item>
                                                        <a-menu-item :disabled="lattice[pid][idx].bottom"
                                                                     @click="command(['mergeBottom', [{pid,idx,data: lattice[pid][idx]}]])">
                                                            {{ t('tableOptions.mergeBottom') }}
                                                        </a-menu-item>
                                                        <a-menu-divider/>
                                                        <a-menu-item
                                                            :disabled="!(lattice[pid][idx].layout && lattice[pid][idx].layout.col > 1)"
                                                            @click="command(['splitCol', [{pid,idx,data: lattice[pid][idx]}]])">
                                                            {{ t('tableOptions.splitCol') }}
                                                        </a-menu-item>
                                                        <a-menu-item
                                                            :disabled="!(lattice[pid][idx].layout && lattice[pid][idx].layout.row > 1)"
                                                            @click="command(['splitRow', [{pid,idx,data: lattice[pid][idx]}]])">
                                                            {{ t('tableOptions.splitRow') }}
                                                        </a-menu-item>
                                                        <a-menu-divider/>
                                                        <a-menu-item :disabled="rule.col < 2"
                                                                     @click="command(['rmCol', [{pid,idx,data: lattice[pid][idx]}]])">
                                                            {{ t('tableOptions.rmCol') }}
                                                        </a-menu-item>
                                                        <a-menu-item :disabled="rule.row < 2"
                                                                     @click="command(['rmRow', [{pid,idx,data: lattice[pid][idx]}]])">
