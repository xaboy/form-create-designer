<template>
    <div class="_fd-validate">
                    ...
                    <el-col :span="getSpan(item)">
                        <el-form-item :label="modes[item.mode]">
                            ...
                            <template v-else-if="item.mode === 'validator'">
                                <FnInput v-model="item[item.mode]" name="validator" :args="['value', 'rule']"
        ...
        <el-button class="_fd-validate-btn" size="small" @click="handleCommand">{{ t('validate.rule') }} +</el-button>
    </div>
</template>
