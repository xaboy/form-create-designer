        ...
        const methods = {
            ...
            validateChange(formData) {
                ...
                if (formData.required) {
                    data.activeRule.$required = formData.required;
                } else {
                    delete data.activeRule.$required;
                }
            ...
            makeRule(config, _rule) {
                ...
                if (config.drag) {
                    rule.children.push(drag = methods.makeDrag(config.drag, rule._menu ? rule._menu.name : rule.type, methods.makeChildren([]), {
